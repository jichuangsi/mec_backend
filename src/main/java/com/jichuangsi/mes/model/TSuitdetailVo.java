...
public class TSuitdetailVo {
    ...
    private String compositeType;//组合类型(1粗拉，2中拉，3半成品，4成品等)
    private Integer mouldType;//模具类别(1成品模具/2成套模具/0不使用模具)
    private String mouldTypes;//模具类别(1成品模具/2成套模具/0不使用模具)
    ...
    public String getMouldTypes() {
        return mouldTypes;
    }

    public void setMouldTypes(String mouldTypes) {
